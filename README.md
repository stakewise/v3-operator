...
```bash
docker pull europe-west4-docker.pkg.dev/stakewiselabs/public/v3-operator:v1.2.0
```
...
```bash
docker build --pull -t europe-west4-docker.pkg.dev/stakewiselabs/public/v3-operator:v1.2.0 .
```
...
docker run --rm -ti \
-v ~/.stakewise/:/data \
europe-west4-docker.pkg.dev/stakewiselabs/public/v3-operator:v1.2.0 \
src/main.py COMMAND \
--flagA=123 \
--flagB=xyz
```
