...
```bash
docker pull europe-west4-docker.pkg.dev/stakewiselabs/public/v3-operator:v4.2.2
```
...
```bash
docker build --pull -t europe-west4-docker.pkg.dev/stakewiselabs/public/v3-operator:v4.2.2 .
```
...
-u $(id -u):$(id -g) \
-v ~/.stakewise/:/data \
europe-west4-docker.pkg.dev/stakewiselabs/public/v3-operator:v4.2.2 \
src/main.py COMMAND \
--flagA=123 \
--flagB=xyz
```
