...
from src.config.settings import OUTDATED_SIGNATURES_URL_PATH, SettingsStore
...
async def _fetch_outdated_indexes(oracle_endpoint: str) -> list[int]:
    path = OUTDATED_SIGNATURES_URL_PATH.format(vault=SettingsStore().VAULT_CONTRACT_ADDRESS)
