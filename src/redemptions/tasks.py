...
async def get_vault_to_redemption_assets(
    ...
    total_redemption_assets = await os_token_redeemer_contract.get_exit_queue_missing_assets(ticket)
    if settings.network in GNO_NETWORKS:
        total_redemption_assets = convert_to_mgno(total_redemption_assets)
