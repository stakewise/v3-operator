...
class ValidatorRegistrationSubtask:
    ...
    async def process_funding(
        ...
        funding_amounts = get_funding_amounts(
...
async def register_new_validators(
    ...
    validators_amounts = get_deposits_amounts(vault_assets, settings.validator_type)
...
def get_deposits_amounts(vault_assets: Gwei, validator_type: ValidatorType) -> list[Gwei]:
